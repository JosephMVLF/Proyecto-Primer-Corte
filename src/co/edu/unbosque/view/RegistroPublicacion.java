...
public class RegistroPublicacion extends JFrame{
	    ...
	    private void initComponents() {
			...
			lblUeb.setBounds(240, 160, 600, 250);
			lblUeb.setIcon(ueb);
			this.add(lblUeb);
	        ...
	        lblTitulo.setBounds(160, 20, 500, 30);
	        ...
	        cbPublicacion.setBounds(160, 100, 200, 25);
	        ...
	        btnVolver.setBounds(400, 195, 200, 40);
